...
import 'additional_row.dart';

class SagatlaynMainBottomSheet extends StatefulWidget {
  const SagatlaynMainBottomSheet({super.key});

  @override
  State<SagatlaynMainBottomSheet> createState() =>
      _SagatlaynMainBottomSheetState();
}

class _SagatlaynMainBottomSheetState extends State<SagatlaynMainBottomSheet> {
          ...
          child:
            ...
            Row(
              children: [
                ...
                const Spacer(),
                Text(
                  myLocationResult != null ? "1 sagat" : "? sagat",
                  style: AppColors.textStyle,
                ),
                const SizedBox(
                  width: 30,
            ...
            Row(
              children: [
                ...
                const Spacer(),
                Text(
                  myLocationResult != null ? "100 TMT" : "? TMT",
                  style: AppColors.textStyle,
                ),
                const SizedBox(
                  width: 30,
